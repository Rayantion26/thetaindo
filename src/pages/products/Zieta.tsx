        ...
        <div className="container mx-auto px-4 py-12 md:py-24">
            ...
            >
                <div className="grid md:grid-cols-3 gap-8">
                    <div className="md:col-span-1 relative aspect-square bg-gradient-to-br from-purple-500/10 to-purple-600/5 flex items-center justify-center p-8">
                        <div className="absolute inset-0 opacity-5 bg-purple-500" />
                        <span className="text-9xl font-bold text-purple-500/20 absolute">Z</span>
                        <div className="relative text-center">
                            <div className="text-6xl font-bold text-purple-600 mb-2">Zieta</div>
                            <div className="text-sm text-muted-foreground uppercase tracking-wider">Elektroda Las</div>
                        </div>
                    </div>
